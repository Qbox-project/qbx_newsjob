return {
    ...
    locations = {
        ...
        inside = {label = 'Weazle News HQ Inside', coords = vector4(-77.46, -833.77, 243.38, 67.5)},
        outside = {label = 'Weazle News HQ Outside', coords = vector4(-598.25, -929.86, 23.86, 86.5)},
        vehicleStorage = {label = 'Vehicle Storage', coords = vector4(-552.24, -925.61, 23.86, 242.5)},
